...
int - typ całkowity, który przyjmuje wartości całkowite
num - typ zmiennoprzecinkowy, który przyjmuje wartości ułamkowe 
char - typ znakowy, przechowuje łańcuchy tekstowe
