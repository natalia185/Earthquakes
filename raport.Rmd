...
W nastepnym kroku sprawdzimy zależności pomiędzy poszczególnymi zmiennywmi. W tym celu tworzymy macierz korelacji \ref{corrpl}.
...
W ceku zbadania owej zależnośi równie posłużymy się wykresem słupkowym. Na potrzeby zrobienia wykresu, zaokrąglone, do najbliższej całkowitej godziny, zostały zmienne z kolumny `Time`.
...
Przechodząc do podsumowania naszej pracy przeprowadzona przez nas analiza dla danych na temat trzęsień ziemi z lat 1900-2013 doprowadziła nas do następujących wniosków. Po pierwsze odpowiadając na pytanie badawcze postawione na początku pracy możemy stwierdzić, że najbardziej narażone na występowanie trzęsień ziemi były regiony azjatyckie, Oceania jak również zachodnie wybrzeża Ameryki Południowej oraz Ameryki Północnej (\ref{world}). Stąd wniosek, że to właśnie te regiony są najbardziej narażone. Jeśli jednak spojrzymy na konkretne państwa to zgodnie z wykresem \ref{barplot1} w czołowej trójce plasują się takie państwa jak Indonezja, Papua-Nowa Gwinea i Japonia. Idąc dalej...
